...
local entity = Spawner:Create({
	Entity = {
		Name = "A-60",
		Asset = "https://github.com/LukeLor/LukeLor/blob/main/DoorsStuffOther/A-60.rbxm?raw=true",
		HeightOffset = 0
	},
	Lights = {
		Flicker = {
	...
	Death = {
		...
		Hints = {"You died to A-60.", "Otherwise known as: \"The Multimonster.\"", "I thought you'd be a little bit more aware to survive.", "Well, the more you know!", "Get back up and get out there yet again!", "I have faith in you.", "Even if it's small."},
		Cause = "A-60"
	}
})
...
lightCup.Color = Color3.fromRGB(255,0,0)
				lightCup.Parent:FindFirstChildOfClass("PointLight").Color = Color3.fromRGB(255,0,0)
			end
		end
