...
local entity = Spawner:Create({
	Entity = {
		Name = "A-35",
		Asset = "https://github.com/LukeLor/LukeLor/blob/main/DoorsStuffOther/A-35.rbxm?raw=true",
		HeightOffset = 0
	},
	Lights = {
		Flicker = {
	...
	Death = {
		...
		Hints = {"You died to A-35.", "Yet again, you should be familiar with the mechanics by now.", "Someone like Ambush, perhaps?", "Anyways, give it another shot.", "I believe in you, you'll be able to do this."},
		Cause = "A-35"
	}
})
