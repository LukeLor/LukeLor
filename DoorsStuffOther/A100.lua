...
local entity = Spawner:Create({
	Entity = {
		Name = "A-100",
		Asset = "https://github.com/LukeLor/LukeLor/blob/main/DoorsStuffOther/A-100.rbxm?raw=true",
		HeightOffset = 0
	},
	Lights = {
		Flicker = {
	...
	Death = {
		...
		Hints = {"You died to A-100...", "There's something wrong this way...", "You can possibly escape a cave and a hotel...", "But not this?", "Just... try better next time."},
		Cause = "A-100"
	}
})
