...
storedtexttolua = usedtable[tostring(string.sub(Text,1, i))]
    ...
    local result = ""
    for i = 1, #Text do
      local chunk = string.sub(Text, i, i)
      local char = usedtable[chunk]
      if not char then
        result = result .. "?"
      else
 ...
 local msg=   EncodeTo("Challenge Mode should really be in doors, y'know? It's a pretty cool concept that Capztion made! So, LSplash, why don't you, uhhh.... add it?", "binary")
print(msg)
local recode = EncodeTo(msg,"text")
print(recode)
